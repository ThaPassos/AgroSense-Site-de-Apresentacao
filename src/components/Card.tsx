        ...
        <div className="card2">
          <div className="upper">
            <div className="humidity">
              <div className="humiditytext">Umidade<br />{displayData.humidity}%</div>
          ...
          KHRFWHRkYXRlOnRpbWVzdGFtcAAyMDIzLTAyLTE2VDE4OjE5OjAwKzAwOjAwSbgwlgAAAABJRU5ErkJggg==" y={0} x={0} height={30} width={30} id="image0" />
            ...
            <div className="air">
              <div className="airtext">Velocidade do vento <br />{displayData.windSpeed} Km/h</div>
          ...
          OFQwNToxNToyNiswMDowMIjQlfwAAAAASUVORK5CYII=" />
              ...
              <div className="realfeeltext">Sensação Térmica<br />{displayData.feelsLike}°C</div>
            </div>
